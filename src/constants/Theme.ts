...
const SeolhunThemes: ISeolhunThemes = {
  LIGHT: {
    ...
    border: {
      color: 'grey',
      radius: '4px',
      shadow: `0 1px 3px ${LocalizeThemes.lightgrey}, 0 1px 2px ${LocalizeThemes.lightgrey}`,
    },
    grid: {
      containerGutter: {
        right: '15px',
  ...
  DARK: {
    ...
    border: {
      color: 'grey',
      radius: '4px',
      shadow: `0 1px 3px ${LocalizeThemes.darkgrey}, 0 1px 2px ${LocalizeThemes.darkgrey}`,
    },
    grid: {
      containerGutter: {
        right: '15px',
