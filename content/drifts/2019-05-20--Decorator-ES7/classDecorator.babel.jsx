...
function logRender(constructor) {
  var original = constructor.prototype.render;

  constructor.prototype.render = function() {
    console.log('Rendering '.concat(constructor.name, '...'));
    return original.apply(this, arguments);
  };
}

// decorators, factory, superClass, mixins
var Todos = _decorate(
  [logRender],
      ...
      (function(_Component2) {
        ...
        function Todos() {
          ...
          _this = _possibleConstructorReturn(
            this,
            (_getPrototypeOf2 = _getPrototypeOf(Todos)).call.apply(
              _getPrototypeOf2,
              [this].concat(args)
            )
          );
